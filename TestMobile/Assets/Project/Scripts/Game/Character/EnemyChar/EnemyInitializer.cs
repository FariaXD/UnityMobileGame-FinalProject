        ...
        foreach (var att in attacks)
        {
            ...
            switch(att.Value["type"]){
                case "Damage":
                    ...
                    newEnemy.enemyAttacks.AddAttack(new CardDamage(area,dmg*amm));
                    break;
                case "Status":
                    ...
                    newEnemy.enemyAttacks.AddAttack(new CardStatus(area, status, duration, dmg));
                    break;
                case "Defense":
                    ...
                    newEnemy.enemyAttacks.AddAttack(new CardDefense(area, defType, amm));
                    break;
                case "Special":
